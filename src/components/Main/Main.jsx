...
const Main = ({ userData, userRepos, reposCount, handleSetPage }) => {
    ...
    <div className="main">
      <div className="main__user">
        ...
        <div className="main__nickname">
          <a href={html_url} rel="noopener" target="about_blank">
            {login}
          </a>
        </div>
        <div className="main__followings">
          <Followings
            img={followersImg}
            quantity={quantityFollowers(followers)}
          >
            followers
          </Followings>
          <Followings
            img={followingImg}
            quantity={quantityFollowers(following)}
          >
            followings
          </Followings>
        </div>
      ...
      {reposCount === 0 ? (
        <Report img={repository}>Repository list is empty</Report>
      ) : (
        <Repositories
          userRepos={userRepos}
